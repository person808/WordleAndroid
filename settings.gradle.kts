dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("androidx-compose-ui-tooling", "androidx.compose.ui", "ui-tooling").versionRef(
                compose
            )
            ...
            // Protobuf
            library("protobuf-javalite", "com.google.protobuf", "protobuf-javalite").versionRef(
                protobuf
            )
